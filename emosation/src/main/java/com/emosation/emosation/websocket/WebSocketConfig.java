...
//    private final GoogleNLPService googleNLPService;
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(new MyWsHandler(wsSessionManager,chatService,redisChatService,openAiService,redisMessageService,redisSessionService,userService),"/ws-login") .setAllowedOrigins("https://localhost:8080")  .addInterceptors(new WebSocketHandShakeInterCeptor(jwtUtil, wsSessionManager));
