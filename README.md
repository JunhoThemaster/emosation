...
### 🔴 동시성 문제 
 ...
 ![스크린샷 2025-01-07 171024](https://github.com/user-attachments/assets/c43f8f25-3a9c-4621-8204-ed8deac2b10a)
  - 결과:
   ...
   #### 🔵 방법2 
    1. **Redis 분산 Lock 적용** : Redis를 학습하며 배운 SETNX 연산을 활용하여 회원가입 요청이 들어올때 이메일 값을 이용하여 키를 생성 -> 키가 존재하면 true 아니면 false를 반환하게 하여 true일 경우에만 회원가입 로직으로 접근
                                 ...
                                 이를 5초 동안 유지 하게 됩니다. 먼저 들어온 요청 1개 에 대한 요청만 처리를 보장해 주기에 동시성 문제는 이렇게 해결 됐습니다. 
